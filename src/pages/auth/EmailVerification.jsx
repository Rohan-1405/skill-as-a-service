 ...
 *
 * Also reads ?email= param (from Praveen's Register flow) to display the email address.
 */
  ...
  return (
    <AuthLayout>
      ...
      <div style={{
        ...
        background: isVerified ? 'rgba(100, 255, 218, 0.08)' : 'rgba(26, 159, 224, 0.1)',
        border: `1px solid ${isVerified ? 'rgba(100, 255, 218, 0.25)' : 'rgba(26, 159, 224, 0.2)'}`,
      ...
      <div className="auth-heading">
        ...
        {email && !isVerified && (
          <p>We sent a verification link to <strong style={{ color: 'var(--color-accent)' }}>{email}</strong></p>
        )}
        {!email && !isVerified && (
          <p>We've sent a verification link to your registered email address. Click the link to activate your account.</p>
        )}
        {isVerified && (
