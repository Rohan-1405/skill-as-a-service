// ============================================================
// SkillAsAService — InvoicesPage.jsx
// Author: Praveen Gorla  |  Day 8
//
// Invoice Screens — Praveen's Day 8 deliverable
//
// Screens included (tab-based, all in one file):
//   1. Invoice List  — searchable, filterable table of all invoices
//   2. Invoice Detail — full breakdown modal (line items, tax, total)
//   3. Invoice PDF Preview — printable/downloadable invoice layout
//
// Per BRD Module 15: Tax Management → Invoice Generation
// Per SRS Module 4: Payment Management → Invoice
// Per Resource Plan Day 8: Praveen → Invoice Screens
// ============================================================
...
const INVOICES = [
  {
    id: 'INV-2026-0018',
    subscription: 'Standard Plan — Arjun Sharma',
    freelancer: 'Arjun Sharma',
    client: 'Praveen Gorla',
    date: '17 Jun 2026',
    dueDate: '17 Jun 2026',
    subtotal: 5084.75,
    gst: 915.25,
    ...
    gateway: 'Razorpay',
    items: [
      { description: 'Standard Plan — Monthly Subscription', qty: 1, rate: 5084.75, amount: 5084.75 },
    ],
  },
  {
    id: 'INV-2026-0017',
    subscription: 'Basic Plan — Priya Menon',
    ...
    gateway: 'UPI',
    items: [
      { description: 'Basic Plan — Monthly Subscription', qty: 1, rate: 2542.37, amount: 2542.37 },
    ],
  },
  {
    id: 'INV-2026-0016',
    subscription: 'Premium Plan — Rohan Gupta',
    freelancer: 'Rohan Gupta',
    client: 'Praveen Gorla',
    date: '05 Jun 2026',
    dueDate: '05 Jun 2026',
    subtotal: 10169.49,
    ...
    gateway: 'Stripe',
    items: [
      { description: 'Premium Plan — Monthly Subscription', qty: 1, rate: 10169.49, amount: 10169.49 },
    ],
  },
  {
    id: 'INV-2026-0014',
...
const NAV_ITEMS = [
  { label: 'Dashboard',    icon: '🏠', path: '/client/dashboard' },
  { label: 'Browse',       icon: '🔍', path: null },
  { label: 'Subscriptions',icon: '📋', path: null },
  { label: 'Projects',     icon: '📁', path: null },
  { label: 'Wallet',       icon: '💰', path: '/client/wallet'   },
  { label: 'Invoices',     icon: '🧾', path: null, active: true },
  { label: 'Messages',     icon: '💬', path: null },
      ...
      <div style={{
        ...
        <style>{`
          ...
          @media print {
            ...
            .invoice-print-area { border: none !important; box-shadow: none !important; }
          }
        `}</style>
        ...
        {/* Invoice Body */}
        <div style={{ padding: '28px 32px' }} className="invoice-print-area">
  ...
  return (
    <>
      ...
      <div style={{ display: 'flex', minHeight: '100vh', background: 'var(--color-bg)', fontFamily: 'var(--font-family)' }}>
        ...
        {/* Overlay */}
        <div className={`inv-overlay${sidebarOpen ? ' open' : ''}`} onClick={() => setSidebarOpen(false)} />
        ...
        <aside className={`inv-sidebar${sidebarOpen ? ' open' : ''}`}>
          ...
          <div style={{ padding: '12px 16px', borderTop: '1px solid var(--color-border)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
              <div style={{ width: 34, height: 34, borderRadius: '50%', background: 'var(--gradient-blue)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 12, fontWeight: 700, color: '#fff' }}>C</div>
              <div>
                <div style={{ fontSize: 13, fontWeight: 600, color: 'var(--color-text)' }}>Client User</div>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
          <DashboardHeader
            pageTitle="Invoices"
            pageSubtitle="Your billing history"
          ...
          <main style={{ flex: 1, padding: '28px', overflowY: 'auto' }}>
            ...
            <div className="inv-stats-grid">
              {[
                { label: 'Total Invoices',    value: totalInvoices,  suffix: '',  icon: '🧾', color: 'var(--color-primary)',  bg: 'rgba(26,159,224,0.10)' },
                { label: 'Total Paid',        value: `₹${totalPaid.toLocaleString('en-IN')}`, suffix: '', icon: '✅', color: 'var(--color-success)', bg: 'rgba(100,255,218,0.08)' },
                { label: 'Total Refunded',    value: `₹${totalRefunded.toLocaleString('en-IN')}`, suffix: '', icon: '🔄', color: 'var(--brand-cyan)', bg: 'rgba(50,220,253,0.10)' },
              ].map(s => (
