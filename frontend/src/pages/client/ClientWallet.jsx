// ============================================================
// SkillAsAService — ClientWallet.jsx
...
export default function ClientWallet() {
  ...
  return (
    <ClientLayout pageTitle="Wallet" pageSubtitle="Manage your funds">
      <style>{`
      ...
      <div style={{ padding: '28px' }}>
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.5)', marginTop: 4 }}>Updated just now</div>
          </div>
